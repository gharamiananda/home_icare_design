...
const AddFINANCIALAIDS = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await fetcher.post("finan_section", featureData);
        console.log(res);
        reset();
    ...
    const statusChange = async (id, stat) => {
        ...
        const res = await fetcher.put(`finan-status/${id}`, statusData);
        console.log(res)
        // toast('Data Successfully uploaded')
    }
...
export default AddFINANCIALAIDS;