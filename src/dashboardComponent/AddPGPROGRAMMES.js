...
const AddPGPROGRAMMES = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const res = await fetcher.post("pg_section", featureData);
        console.log(res);
        reset();
    ...
    const statusChange = async (id, stat) => {
        ...
        const res = await fetcher.put(`pg-status/${id}`, statusData);
        console.log(res)
        // toast('Data Successfully uploaded')
    }
...
export default AddPGPROGRAMMES;